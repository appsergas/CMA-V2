                        ...
                        >
                            {
                                ...
                                >
                                    {/* <FontAwesomeIcon icon={faRectangleXmark} style={{fontSize:50}} /> */}
                                    <View style={styles.rectangularContainer}>
                                        <Icon name="close" style={styles.actionButtonTitleIcon} />
...
const styles = StyleSheet.create({
    ...
    rectangularContainer: {
        ...
        paddingRight: 2,
        margin:2,
        backgroundColor: '#102D4F', // or any desired background color
        borderWidth: 1, // optional, if you want a border
        borderColor: '#102D4F', // optional, the color of the border
        borderRadius: 5, // optional, for rounded corners
    },
});

customLTSModal.PropTypes = {
